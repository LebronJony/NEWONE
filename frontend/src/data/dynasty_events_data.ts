...
export const DYNASTY_EVENTS: Record<number, DynastyEvent[]> = {
  ...
  11: [  // 三国
    { name:'黄巾起义', year:'184', description:'巨鹿人张角创立太平道，发动黄巾军起义。起义军数十万人头裹黄巾席卷八州。东汉调集各州郡镇压，虽平定了起义但地方势力坐大。', significance:'黄巾起义标志着东汉末年的开始。此后群雄割据，最终导致三国鼎立格局的形成。', era:'张角·曹操·刘备', type:'军事' },
    { name:'董卓乱政', year:'189-192', description:'大将军何进召董卓入京诛杀宦官，董卓趁机废少帝立献帝，独揽朝政。关东诸侯组成联军讨伐董卓。司徒王允设计使吕布杀死董卓。', significance:'董卓乱政彻底瓦解了东汉中央权威，开启了群雄逐鹿的序幕。', era:'董卓·吕布·王允', type:'政治' },
    { name:'曹操起兵与陈留起兵', year:'190', description:'曹操在陈留散尽家财招募义兵，加入讨伐董卓的关东联军。虽联军各怀异志未能成功，但曹操从此拥有了自己的武装力量。', significance:'曹操创业的起点。此后他兖州立足收编青州兵，逐步成为北方最强大的军阀。', era:'曹操', type:'军事' },
    { name:'王允诛董卓与李傕郭汜之乱', year:'192', description:'司徒王允利用吕布与董卓的矛盾，设计诛杀董卓。但王允不愿赦免董卓旧部，李傕郭汜在贾诩鼓动下反攻长安，杀死王允控制朝政。', significance:'李傕郭汜之乱使长安陷入更大混乱。汉献帝流离失所，东汉朝廷名存实亡。', era:'王允·吕布·贾诩', type:'政治' },
    { name:'曹操收编青州兵', year:'192', description:'青州黄巾军百万攻入兖州，曹操率军击败黄巾军收降三十余万。选其精锐组建青州兵，成为曹操起家的核心武装力量。', significance:'曹操有了一支真正属于自己的精锐部队，奠定了争霸天下的军事基础。', era:'曹操', type:'军事' },
    { name:'曹操迎奉天子（挟天子以令诸侯）', year:'196', description:'汉献帝在董承护卫下逃出长安回到洛阳，处境艰难。曹操采纳荀彧建议，率军到洛阳迎奉天子迁都许昌，从此挟天子以令诸侯。', significance:'曹操获得了政治上的绝对优势，可以以汉室名义号令天下。此后征讨皆打出天子旗号。', era:'曹操·荀彧', type:'政治' },
    { name:'刘备领徐州', year:'194', description:'陶谦三让徐州与刘备，刘备初辞后受。徐州地处四战之地，北有袁绍南有袁术西有曹操东有吕布，立足极为不易。', significance:'刘备拥有了自己的第一个地盘。但很快因吕布偷袭丢失，此后辗转依附他人。', era:'刘备·陶谦', type:'政治' },
    { name:'袁术称帝与败亡', year:'197-199', description:'袁术据淮南以寿春为都，迷信代汉者当涂高谶语，在寿春僭号称帝号仲家。此举招致天下共讨，曹操孙策吕布四面围攻。袁术内外交困呕血而死。', significance:'袁术是三国时期第一个称帝者。其迅速败亡证明汉室正统仍有强大的号召力。', era:'袁术·曹操·孙策', type:'政治' },
    { name:'曹操收降张绣与宛城之败', year:'197', description:'曹操南征宛城张绣投降。曹操纳张绣婶母邹氏为妾，张绣深感受辱在贾诩策划下发动突袭。曹军大败，曹操长子曹昂爱将典韦战死。', significance:'曹操遭受了生平最惨痛的失败之一。后张绣在贾诩劝说下再次归降，曹操不计前嫌封侯，尽显政治手腕。', era:'曹操·张绣·贾诩', type:'军事' },
    { name:'吕布攻占徐州与辕门射戟', year:'196', description:'袁术攻打刘备，吕布趁乱偷袭下邳占据徐州。袁术派纪灵攻刘备，吕布率军至小沛辕门外树戟一箭正中戟枝，双方惊叹罢兵。', significance:'辕门射戟成为三国著名典故。但吕布反复无常的为人使各方都不信任，199年被曹操擒杀于白门楼。', era:'吕布·刘备·袁术', type:'军事' },
    { name:'孙策平定江东', year:'195-200', description:'孙策以父亲旧部为基础渡江，在周瑜张昭辅佐下先后击败刘繇王朗严白虎等势力，短短数年间平定江东六郡。', significance:'奠定了东吴政权的基础，孙策被称为小霸王。200年遇刺身亡，二十六岁将基业交予孙权。', era:'孙策·周瑜·张昭', type:'军事' },
    { name:'官渡之战', year:'200', description:'曹操与袁绍在官渡决战。袁绍十万大军对阵曹操两三万人。曹操采纳许攸之计奇袭乌巢烧毁袁军粮草，袁绍军大溃。曹操以少胜多。', significance:'官渡之战是曹操统一北方的关键之战。战后曹操逐步消灭袁氏残余势力，成为北方最强者，为三国鼎立奠定基础。', era:'曹操·袁绍·许攸', type:'军事' },
    { name:'仓亭之战', year:'201', description:'官渡战后袁绍退守河北，在仓亭集结兵力试图反击。曹操用程昱十面埋伏之计诱敌深入前后夹击大破袁绍军。', significance:'袁绍再次大败退回邺城，次年呕血而死。曹操彻底掌握了北方主动权。', era:'曹操·袁绍·程昱', type:'军事' },
    { name:'曹操北征乌桓与白狼山之战', year:'207', description:'袁绍子袁尚袁熙逃往北方勾结乌桓单于蹋顿。曹操率军出卢龙塞穿越荒漠直抵白狼山，张辽奋勇冲杀斩蹋顿于阵前，乌桓大败降者二十余万。', significance:'曹操彻底平定北方统一黄河流域。此战是曹操最艰险的远征之一。谋士郭嘉在此次征途中病逝。', era:'曹操·张辽·郭嘉', type:'军事' },
    { name:'赤壁之战', year:'208', description:'曹操率大军南下。孙权刘备联军在赤壁以火攻大败曹操大军。周瑜为前线总指挥，黄盖献火攻计并亲自诈降纵火。', significance:'赤壁之战奠定了三国鼎立的基础。此后曹操退守北方，刘备得荆益二州，孙权巩固江东。', era:'周瑜·诸葛亮·曹操', type:'军事' },
    { name:'周瑜攻取江陵之战', year:'208-209', description:'赤壁战后周瑜率军西进攻打曹仁据守的江陵。周瑜亲自督战被流矢射中右胁带伤坚持指挥。曹仁最终不支撤退。', significance:'孙权占南郡，任周瑜为南郡太守。周瑜随即提出取蜀并张鲁的大战略，未及实施便病逝。', era:'周瑜·曹仁', type:'军事' },
    { name:'刘备借荆州', year:'209-210', description:'赤壁战后曹操占襄樊樊城以北；孙权占南郡；刘备占江南四郡。刘备地小人少向孙权借南郡以安身，鲁肃极力劝谏下孙权同意。', significance:'借荆州增强了刘备实力使其得以西进取益州。但成为孙刘矛盾根源，最终导致吕蒙袭荆州关羽被杀。', era:'刘备·孙权·鲁肃', type:'政治' },
    { name:'周瑜病逝', year:'210', description:'周瑜为东吴规划西取巴蜀北结马超的大战略正亲自准备实施。返回江陵途中箭伤复发病逝于巴丘，年仅三十六岁。临终推荐鲁肃继任。', significance:'周瑜英年早逝是东吴重大损失。正史中的周瑜性度恢廓雅量高致，非演义中嫉妒诸葛亮的狭隘之人。', era:'周瑜·鲁肃', type:'政治' },
    { name:'孙权嫁妹与孙刘联姻', year:'209', description:'孙权采纳周瑜之策将妹嫁刘备以加强联盟。刘备亲赴京口迎娶孙夫人。孙夫人英武身边侍婢持刀侍立，刘备多有畏惧。', significance:'巩固了孙刘联盟。但孙夫人后来与刘备关系不睦，孙权趁刘备入蜀派船接回其妹。', era:'刘备·孙权', type:'政治' },
    { name:'庞统献计取益州', year:'211-214', description:'刘璋邀刘备入蜀讨张鲁。庞统随军献上中下三策，刘备取中策进军雒城。攻城中庞统中流矢身亡年仅三十六岁，刘备痛失凤雏。', significance:'刘备痛失凤雏但继续西进。庞统之死是蜀汉早期最重大的损失之一。', era:'刘备·庞统·刘璋', type:'军事' },
    { name:'刘备取成都', year:'214', description:'庞统死后刘备调诸葛亮张飞赵云入川支援。两路合围成都。刘璋困守孤城开城投降。刘备占据益州自领益州牧。', significance:'刘备以成都为根据地建立了蜀汉基业。三国鼎立格局中蜀汉一方正式确立。', era:'刘备·诸葛亮·张飞', type:'军事' },
    { name:'孙权取交州与广州设州', year:'210-211', description:'孙权以步骘为交州刺史经略南方。步骘率军进入交州士燮归附。孙权将交州分为交州和广州两部分。', significance:'东吴控制了南方大片领土巩固了后方。广州之名始于此。', era:'孙权·步骘·士燮', type:'政治' },
    { name:'曹操平定关中与潼关之战', year:'211', description:'马超韩遂联合关中十部据守潼关。曹操用徐晃贾诩之策偷渡黄河，又在阵前离间马超韩遂使二人相互猜疑，趁其内乱大破关中联军。', significance:'曹操占据关中。马超退守陇西后投奔张鲁最终归刘备。韩遂逃往凉州。', era:'曹操·马超·韩遂', type:'军事' },
    { name:'关羽北伐与樊城之战', year:'219', description:'关羽率军北伐围困樊城。于禁七军来援遇汉水暴涨，关羽水淹七军擒于禁斩庞德威震华夏。曹操联合孙权夹击。', significance:'关羽威震华夏达到其军事生涯巅峰。但后方空虚被吕蒙偷袭荆州，腹背受敌兵败被杀。是蜀汉由盛转衰的转折点。', era:'关羽·于禁·吕蒙', type:'军事' },
    { name:'白衣渡江与吕蒙袭荆州', year:'219', description:'吕蒙以治病为名将精兵藏在商船中白衣沿江而上偷袭江陵公安。守将糜芳傅士仁不战而降。吕蒙对百姓秋毫无犯关羽军心瓦解。', significance:'孙权夺取荆州大部占据长江中游战略要地。孙刘联盟彻底破裂。吕蒙战后病重去世。', era:'吕蒙·孙权·关羽', type:'军事' },
    { name:'曹丕称帝', year:'220', description:'曹操病逝于洛阳，曹丕继承魏王之位。同年十月曹丕逼迫汉献帝禅让，正式称帝建国号魏，是为魏文帝。东汉灭亡。', significance:'东汉正式灭亡。三国时代正式开始。曹丕建立魏朝定都洛阳，追尊曹操为魏武帝。', era:'曹丕·汉献帝', type:'政治' },
    { name:'刘备称帝', year:'221', description:'曹丕称帝后传闻汉献帝已遇害。诸葛亮等群臣劝进，刘备在成都武担山南即皇帝位建国号汉（史称蜀汉）。', significance:'刘备以继承汉室正统自居，蜀汉正式建国。三国鼎立格局最终完成。', era:'刘备·诸葛亮', type:'政治' },
    { name:'夷陵之战与陆逊火烧连营', year:'221-222', description:'刘备为关羽报仇亲率大军伐吴。孙权任命陆逊为大都督。陆逊避其锋芒退守夷陵坚壁不出。刘备连营七百里。陆逊火烧连营大破蜀军。', significance:'陆逊一战成名。刘备元气大伤败退白帝城次年病逝。蜀汉成为三国中最弱的一方。', era:'刘备·陆逊', type:'军事' },
    { name:'曹丕三路伐吴', year:'222-225', description:'曹丕三次伐吴。222年命曹休曹仁曹真三路南征被一一击退。224年和225年曹丕亲临广陵面对长江天险和东吴水军，叹魏虽有武骑千群无所用之最终撤军。', significance:'曹丕三次伐吴均未成功。曹魏始终未能突破长江防线。孙权于222年称吴王229年称帝。', era:'曹丕·孙权', type:'军事' },
    { name:'诸葛亮北伐', year:'228-234', description:'诸葛亮平定南中稳定内政后五次北伐中原。第一次收降姜维但马谡街亭大败；第二次围攻陈仓郝昭坚守粮尽退；第三四次与司马懿对峙因粮尽退军。234年十万大军屯五丈原与司马懿对峙百余日病逝。', significance:'诸葛亮以弱国之势主动出击牵制曹魏大量兵力延缓蜀汉灭亡。他的鞠躬尽瘁死而后已成为千古名臣典范。', era:'诸葛亮·司马懿', type:'军事' },
    { name:'孙权称帝与吴蜀重新结盟', year:'229', description:'孙权在武昌正式称帝建国号吴。蜀汉派陈震前来祝贺，孙权与蜀汉重新缔结盟约约定中分天下。随后孙权迁都建业。', significance:'三国正式进入三帝并立的阶段。形成了长达四十余年的稳定对峙局面。', era:'孙权', type:'政治' },
    { name:'司马懿平辽东', year:'238', description:'公孙渊割据辽东自立为燕王背叛曹魏。司马懿率军四万远征辽东包围襄平大破公孙渊军斩公孙渊父子。', significance:'司马懿平定辽东立下大功声望大增。此战展示了司马懿卓越的军事才能，为其后夺取魏国大权积攒了资本。', era:'司马懿·公孙渊', type:'军事' },
    { name:'高平陵之变', year:'249', description:'曹爽陪同魏帝曹芳出城祭扫高平陵。司马懿趁机在洛阳发动政变控制京城。曹爽犹豫不决最终投降。司马懿以谋反罪诛杀曹爽及其党羽夷灭三族。', significance:'曹魏大权从此落入司马氏手中。司马懿以诈病赚曹爽赢得了政变成功。为西晋代魏奠定了基础。', era:'司马懿·曹爽', type:'政治' },
    { name:'毌丘俭文钦之乱', year:'255', description:'司马师废魏帝曹芳专横跋扈。镇东将军毌丘俭扬州刺史文钦起兵讨伐司马师。司马师亲率大军讨伐大破毌丘俭。文钦战败投奔东吴。', significance:'司马师在此战眼疾加重回师后去世，其弟司马昭接掌大权。曹魏境内再无大规模反抗司马氏的武装势力。', era:'司马师·毌丘俭', type:'军事' },
    { name:'诸葛诞之乱', year:'257-258', description:'征东大将军诸葛诞在寿春起兵联合东吴反司马昭。司马昭率二十六万大军围城，吴军援兵被击退。城中粮尽诸葛诞被部下出卖战败被杀夷灭三族。', significance:'此战平定后曹魏境内再无大规模反抗司马氏的武装势力。司马昭地位更加稳固。', era:'司马昭·诸葛诞', type:'军事' },
    { name:'曹髦讨司马昭被杀', year:'260', description:'魏帝曹髦不甘做司马昭傀儡率宫中卫兵数百人讨伐司马昭。司马昭部将贾充命成济将曹髦刺死于车下。', significance:'司马昭之心路人皆知的典故即源于此。曹髦是中国历史上第一位为保卫皇权亲临战阵最终战死的皇帝。', era:'司马昭·曹髦', type:'政治' },
    { name:'邓艾偷渡阴平', year:'263', description:'司马昭命钟会邓艾分兵伐蜀。姜维退守剑阁与钟会对峙。邓艾率军从阴平道无人山区凿山开路七百里如天降般出现在江油。诸葛瞻战死绵竹，邓艾兵临成都。', significance:'邓艾的军事奇谋决定了蜀汉的命运。刘禅开城投降蜀汉灭亡。三国鼎立从此打破。', era:'邓艾·姜维·刘禅', type:'军事' },
    { name:'钟会之乱与姜维复国计划', year:'264', description:'灭蜀后钟会野心膨胀欲据蜀自立。姜维假意投靠想借钟会之手复辟蜀汉。魏军将士不愿反叛发动兵变钟会姜维均在混战中被杀。', significance:'姜维复国计划失败蜀汉再无复兴之望。蜀汉灭亡后姜维以死报国完成最后忠义。', era:'钟会·姜维', type:'军事' },
    { name:'司马昭去世与西晋代魏', year:'265', description:'264年司马昭被封为晋王。265年病逝其子司马炎继位为晋王。266年司马炎逼魏元帝曹奂禅让建立西晋。', significance:'司马昭至死未称帝但为西晋代魏扫清了全部障碍。280年西晋灭吴统一全国。', era:'司马昭·司马炎', type:'政治' },
  ],
};
