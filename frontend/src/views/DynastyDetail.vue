...
const DYNASTY_EVENTS: Record<number, DynastyEvent[]> = {
  1: [  // 秦
    ...
    { name:'秦灭六国', year:'前230-前221', description:'秦王嬴政先后灭韩、赵、魏、楚、燕、齐六国，结束了长达五百余年的诸侯割据局面，建立了中国历史上第一个大一统中央集权王朝。', significance:'结束了春秋战国长期分裂的局面，开创了中国两千多年的帝制时代。"皇帝"称号自此成为最高统治者的称谓。', era:'秦始皇', type:'军事', detail:'【背景】秦灭六国是秦始皇时期一次具有重大历史意义的军事行动，发生在前230-前221前后。\n\n【经过】秦王嬴政先后灭韩、赵、魏、楚、燕、齐六国，结束了长达五百余年的诸侯割据局面，建立了中国历史上第一个大一统中央集权王朝。\n\n【后果与影响】结束了春秋战国长期分裂的局面，开创了中国两千多年的帝制时代。"皇帝"称号自此成为最高统治者的称谓。' },
    { name:'焚书坑儒', year:'前213-前212', description:'秦始皇采纳李斯建议，焚烧除秦记、医药、卜筮、种树以外的书籍。次年将四百六十余名方士儒生坑杀于咸阳。', significance:'严重摧毁了先秦诸子百家的文化遗产，是中国历史上第一次大规模的文化专制事件。', era:'秦始皇·李斯', type:'政治', detail:'【背景】焚书坑儒是秦始皇·李斯时期一次具有重大历史意义的政治事件，发生在前213-前212前后。\n\n【经过】秦始皇采纳李斯建议，焚烧除秦记、医药、卜筮、种树以外的书籍。次年将四百六十余名方士儒生坑杀于咸阳。\n\n【后果与影响】严重摧毁了先秦诸子百家的文化遗产，是中国历史上第一次大规模的文化专制事件。' },
    { name:'修筑长城', year:'前214', description:'秦始皇下令将战国秦赵燕三国北部长城连接修缮，西起临洮东至辽东，绵延万余里。动用数百万民夫。', significance:'长城成为中华民族的象征，但在当时因工程浩大导致无数百姓家破人亡，成为秦朝暴政的典型代表。', era:'秦始皇·蒙恬', type:'军事', detail:'【背景】修筑长城是秦始皇·蒙恬时期一次具有重大历史意义的军事行动，发生在前214前后。\n\n【经过】秦始皇下令将战国秦赵燕三国北部长城连接修缮，西起临洮东至辽东，绵延万余里。动用数百万民夫。\n\n【后果与影响】长城成为中华民族的象征，但在当时因工程浩大导致无数百姓家破人亡，成为秦朝暴政的典型代表。' },
    { name:'大泽乡起义', year:'前209', description:'陈胜吴广在安徽大泽乡率九百戍卒起义，提出"王侯将相宁有种乎"，揭开了秦末农民大起义的序幕，各地纷纷响应。', significance:'中国历史上第一次大规模平民起义，沉重打击了秦朝统治，最终导致秦朝灭亡。也为后世农民起义提供了精神号召。', era:'陈胜·吴广', type:'军事', detail:'【背景】大泽乡起义是陈胜·吴广时期一次具有重大历史意义的军事行动，发生在前209前后。\n\n【经过】陈胜吴广在安徽大泽乡率九百戍卒起义，提出"王侯将相宁有种乎"，揭开了秦末农民大起义的序幕，各地纷纷响应。\n\n【后果与影响】中国历史上第一次大规模平民起义，沉重打击了秦朝统治，最终导致秦朝灭亡。也为后世农民起义提供了精神号召。' },
    { name:'巨鹿之战', year:'前207', description:'项羽率楚军与秦军主力在巨鹿决战。项羽破釜沉舟，以少胜多大败秦军。此战后秦军主力尽失，名存实亡。', significance:'巨鹿之战决定了秦朝灭亡的命运。项羽一战成名，成为反秦联军领袖。同时秦将章邯投降，王离被俘。', era:'项羽·章邯', type:'军事', detail:'【背景】巨鹿之战是项羽·章邯时期一次具有重大历史意义的军事行动，发生在前207前后。\n\n【经过】项羽率楚军与秦军主力在巨鹿决战。项羽破釜沉舟，以少胜多大败秦军。此战后秦军主力尽失，名存实亡。\n\n【后果与影响】巨鹿之战决定了秦朝灭亡的命运。项羽一战成名，成为反秦联军领袖。同时秦将章邯投降，王离被俘。' },
    { name:'秦统一度量衡与文字', year:'前221', description:'秦始皇统一六国后推行书同文车同轨政策，以小篆为全国标准文字，统一度量衡单位。', significance:'奠定了中国两千年大一统的文化基础。书同文使各地文化交流更加便利。', era:'秦始皇·李斯', type:'改革', detail:'【背景】秦统一度量衡与文字是秦始皇·李斯时期一次具有重大历史意义的改革，发生在前221前后。\n\n【经过】秦始皇统一六国后推行书同文车同轨政策，以小篆为全国标准文字，统一度量衡单位。\n\n【后果与影响】奠定了中国两千年大一统的文化基础。书同文使各地文化交流更加便利。' },
    { name:'灵渠修建', year:'前214', description:'秦始皇为征服岭南开凿灵渠连接湘江和漓江，沟通长江与珠江水系，全长约36公里。', significance:'世界上最古老的运河之一。使中原王朝有效控制岭南地区，促进了南北经济文化交流。', era:'秦始皇·史禄', type:'工程', detail:'【背景】灵渠修建是秦始皇·史禄时期一次具有重大历史意义的工程壮举，发生在前214前后。\n\n【经过】秦始皇为征服岭南开凿灵渠连接湘江和漓江，沟通长江与珠江水系，全长约36公里。\n\n【后果与影响】世界上最古老的运河之一。使中原王朝有效控制岭南地区，促进了南北经济文化交流。' },
  ],
  2: [  // 汉
    { name:'楚汉争霸', year:'前206-前202', description:'秦朝灭亡后项羽分封天下，封刘邦为汉王。刘邦趁机出兵关中，与项羽进行了长达四年的楚汉战争。最终在垓下之战中击败项羽。', significance:'以刘邦的胜利告终，奠定了西汉王朝的统治基础。刘邦从平民成为开国皇帝，是中国历史上"布衣天子"的典范。', era:'刘邦·项羽', type:'军事', detail:'【背景】楚汉争霸是刘邦·项羽时期一次具有重大历史意义的军事行动，发生在前206-前202前后。\n\n【经过】秦朝灭亡后项羽分封天下，封刘邦为汉王。刘邦趁机出兵关中，与项羽进行了长达四年的楚汉战争。最终在垓下之战中击败项羽。\n\n【后果与影响】以刘邦的胜利告终，奠定了西汉王朝的统治基础。刘邦从平民成为开国皇帝，是中国历史上"布衣天子"的典范。' },
    { name:'白登之围', year:'前200', description:'刘邦亲率大军北击匈奴，被匈奴冒顿单于四十万骑兵围困于白登山七昼夜。后采纳陈平之计贿赂匈奴阏氏才得脱险。', significance:'使汉朝认识到匈奴的强大，从此采取和亲政策换取和平，为汉朝恢复国力赢得了宝贵时间。', era:'刘邦·冒顿单于', type:'外交', detail:'【背景】白登之围是刘邦·冒顿单于时期一次具有重大历史意义的外交往来，发生在前200前后。\n\n【经过】刘邦亲率大军北击匈奴，被匈奴冒顿单于四十万骑兵围困于白登山七昼夜。后采纳陈平之计贿赂匈奴阏氏才得脱险。\n\n【后果与影响】使汉朝认识到匈奴的强大，从此采取和亲政策换取和平，为汉朝恢复国力赢得了宝贵时间。' },
    { name:'文景之治', year:'前180-前141', description:'汉文帝和汉景帝实行轻徭薄赋、与民休息的政策。文帝废除肉刑、减省租赋，景帝平定七国之乱、削弱诸侯。', significance:'中国历史上第一个有明确记载的太平盛世，为汉武帝时期的大规模军事行动奠定了物质基础。', era:'汉文帝·汉景帝', type:'政治', detail:'【背景】文景之治是汉文帝·汉景帝时期一次具有重大历史意义的政治事件，发生在前180-前141前后。\n\n【经过】汉文帝和汉景帝实行轻徭薄赋、与民休息的政策。文帝废除肉刑、减省租赋，景帝平定七国之乱、削弱诸侯。\n\n【后果与影响】中国历史上第一个有明确记载的太平盛世，为汉武帝时期的大规模军事行动奠定了物质基础。' },
    { name:'七国之乱', year:'前154', description:'汉景帝采纳晁错削藩建议，引发吴王刘濞联合七国叛乱。景帝派周亚夫率军平叛，三个月内平定。', significance:'标志着西汉中央集权的全面胜利。此后诸侯王不再拥有军事行政大权，从根本上解决了诸侯坐大的问题。', era:'周亚夫·晁错', type:'军事', detail:'【背景】七国之乱是周亚夫·晁错时期一次具有重大历史意义的军事行动，发生在前154前后。\n\n【经过】汉景帝采纳晁错削藩建议，引发吴王刘濞联合七国叛乱。景帝派周亚夫率军平叛，三个月内平定。\n\n【后果与影响】标志着西汉中央集权的全面胜利。此后诸侯王不再拥有军事行政大权，从根本上解决了诸侯坐大的问题。' },
    { name:'汉武帝北击匈奴', year:'前133-前87', description:'汉武帝派卫青、霍去病多次出击匈奴。漠北之战霍去病封狼居胥山，匈奴从此无力南下。张骞出使西域开辟丝绸之路。', significance:'扭转了汉匈攻守态势，"匈奴远遁，漠南无王庭"。丝绸之路促进中西交流。', era:'汉武帝·卫青·霍去病', type:'军事', detail:'【背景】汉武帝北击匈奴是汉武帝·卫青·霍去病时期一次具有重大历史意义的军事行动，发生在前133-前87前后。\n\n【经过】汉武帝派卫青、霍去病多次出击匈奴。漠北之战霍去病封狼居胥山，匈奴从此无力南下。张骞出使西域开辟丝绸之路。\n\n【后果与影响】扭转了汉匈攻守态势，"匈奴远遁，漠南无王庭"。丝绸之路促进中西交流。' },
    ...
    { name:'昭君出塞', year:'前33', description:'汉元帝将宫女王昭君嫁给匈奴呼韩邪单于。昭君出塞后汉匈和平五十余年。', significance:'和亲政策的典范。昭君出塞成为民族团结的象征，在文学艺术中被广为传颂。', era:'王昭君·呼韩邪单于', type:'外交', detail:'【背景】昭君出塞是王昭君·呼韩邪单于时期一次具有重大历史意义的外交往来，发生在前33前后。\n\n【经过】汉元帝将宫女王昭君嫁给匈奴呼韩邪单于。昭君出塞后汉匈和平五十余年。\n\n【后果与影响】和亲政策的典范。昭君出塞成为民族团结的象征，在文学艺术中被广为传颂。' },
    { name:'王莽篡汉', year:'9-23', description:'外戚王莽废孺子婴，建立新朝。王莽推行复古改制，引发天下大乱。绿林军、赤眉军起义。', significance:'西汉灭亡。王莽改制是中国历史上一次重要但失败的改革实验。', era:'王莽', type:'政治', detail:'【背景】王莽篡汉是王莽时期一次具有重大历史意义的政治事件，发生在9-23前后。\n\n【经过】外戚王莽废孺子婴，建立新朝。王莽推行复古改制，引发天下大乱。绿林军、赤眉军起义。\n\n【后果与影响】西汉灭亡。王莽改制是中国历史上一次重要但失败的改革实验。' },
    { name:'昆阳之战', year:'23', description:'刘秀率一万七千人在昆阳迎战王莽四十万大军。以少胜多，内外夹击大破莽军。此战后刘秀声威大震。', significance:'奠定了刘秀推翻王莽复兴汉室的基础。为建立东汉开辟了道路。', era:'刘秀·王莽', type:'军事', detail:'【背景】昆阳之战是刘秀·王莽时期一次具有重大历史意义的军事行动，发生在23前后。\n\n【经过】刘秀率一万七千人在昆阳迎战王莽四十万大军。以少胜多，内外夹击大破莽军。此战后刘秀声威大震。\n\n【后果与影响】奠定了刘秀推翻王莽复兴汉室的基础。为建立东汉开辟了道路。' },
    { name:'光武中兴', year:'25-57', description:'刘秀建立东汉，释放奴婢、减省刑法、裁并郡县、精简官吏。退功臣而进文吏，使政治清明。', significance:'使汉朝国祚延续近两百年。刘秀柔道治国的理念开创了不同于西汉的统治风格。', era:'汉光武帝', type:'政治', detail:'【背景】光武中兴是汉光武帝时期一次具有重大历史意义的政治事件，发生在25-57前后。\n\n【经过】刘秀建立东汉，释放奴婢、减省刑法、裁并郡县、精简官吏。退功臣而进文吏，使政治清明。\n\n【后果与影响】使汉朝国祚延续近两百年。刘秀柔道治国的理念开创了不同于西汉的统治风格。' },
    ...
    { name:'丝绸之路', year:'前138-127', description:'张骞奉汉武帝之命两次出使西域，开辟了连接中国与中亚、西亚乃至欧洲的商路。丝绸之路成为东西方文明交流的大动脉。', significance:'丝绸之路促进了中国与世界的经济文化交流。张骞被誉为"第一个睁开眼睛看世界的中国人"。', era:'张骞·汉武帝', type:'文化', detail:'【背景】丝绸之路是张骞·汉武帝时期一次具有重大历史意义的文化成果，发生在前138-127前后。\n\n【经过】张骞奉汉武帝之命两次出使西域，开辟了连接中国与中亚、西亚乃至欧洲的商路。丝绸之路成为东西方文明交流的大动脉。\n\n【后果与影响】丝绸之路促进了中国与世界的经济文化交流。张骞被誉为"第一个睁开眼睛看世界的中国人"。' },
